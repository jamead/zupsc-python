...
def get_sa_data(psc_prefix):
  ...
  sa_pv.append(psc_prefix+"Chan3:DCCT1-I")
  sa_pv.append(psc_prefix+"Chan3:DCCT2-I") 
  sa_pv.append(psc_prefix+"Chan3:DAC-I")
  #sa_pv.append(psc_prefix+"Chan2:Volt-I")
  #sa_pv.append(psc_prefix+"Chan2:Gnd-I")
  #sa_pv.append(psc_prefix+"Chan2:Spare-I")
  sa_pv.append(psc_prefix+"Chan3:Reg-I")
  ...
  sa_pv.append(psc_prefix+"Chan3:Error-I") 
...
def main():
  ...
  with open(filename,'w',buffering=1) as outfile:
      for i in range(1,numpts):         
         ...
         ts = 0;
         print("%8d:\t%10d\t %2.6f\t %2.6f\t %2.6f\t %2.6f\t %2.6f\t %2.6f"  % (i,ts,data[0],data[1],data[2],data[3],data[4],data[5]))
         print("%10d\t %2.6f\t %2.6f\t %2.6f\t %2.6f\t %2.6f\t %2.6f" 
            % (i,data[0],data[1],data[2],data[3],data[4],data[5]),file=outfile)
